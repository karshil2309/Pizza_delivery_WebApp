          ...
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover" id="example" >
              ...
              <tr>
                ...
                <th class='sort_by' data-id='2'>USer Id</th>
                <th class='sort_by' data-id='3'>Company Name</th>
                <th class='sort_by' data-id='4'>Logo Info..</th>
                <th class='sort_by' data-id='5'>Description</th>
                <th class='sort_by' data-id='6'>WebSite of COmpany</th>
              ...
              $sql = "SELECT * FROM company_details LIMIT $offset,25 ";
